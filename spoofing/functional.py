...
def _is_pil_image(img):
    ...
    Returns:
        bool: True if img is a PIL image, False otherwise.
    """
...
def _is_tensor_image(img):
    """Check if the input is a tensor image.

    Args:
        img: Input image.

    Returns:
        bool: True if img is a tensor image, False otherwise.
    """
...
def _is_numpy_image(img):
    ...
    Returns:
        bool: True if img is a numpy image, False otherwise.
    """
...
def scale(*args, **kwargs):
    """Deprecated scale function, use resize instead."""
...
def center_crop(img, output_size):
    ...
    Args:
        img (PIL Image): Image to be cropped.
        output_size (int or tuple): Desired output size of the crop. If size is an
...
def adjust_gamma(img, gamma, gain=1):
    ...
    Args:
        img (PIL Image): PIL Image to be adjusted.
        gamma (float): Non-negative real number. gamma larger than 1 makes the
            shadows darker, while gamma smaller than 1 makes dark regions
            lighter.
...
def rotate(img, angle, resample=False, expand=False, center=None):
    ...
    Args:
        ...
        angle ({float, int}): In degrees counter clockwise order.
...
def to_grayscale(img, num_output_channels=1):
    ...
    Args:
        ...
        num_output_channels (int): Number of output channels. Default is 1.
