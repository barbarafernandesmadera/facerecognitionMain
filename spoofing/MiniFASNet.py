...
class Conv_block(Module):
    """
    A convolutional block with Conv2d, BatchNorm2d, and PReLU.
    """
...
class Linear_block(Module):
    """
    A linear block with Conv2d and BatchNorm2d.
    """
    def __init__(self, in_c, out_c, kernel=(1, 1), stride=(1, 1), padding=(0, 0), groups=1):
...
class Depth_Wise(Module):
    """
    A depth-wise convolutional block with optional residual connection.
    """
...
class Residual(Module):
    """
    A residual block consisting of multiple Depth_Wise blocks.
    """
...
class Depth_Wise_SE(Module):
    """
    A depth-wise convolutional block with Squeeze-and-Excitation and optional residual connection.
    """
...
class ResidualSE(Module):
    """
    A residual block consisting of multiple Depth_Wise_SE blocks.
    """
...
class MiniFASNet(Module):
    """
    MiniFASNet model for face anti-spoofing.
    """
...
class MiniFASNetSE(MiniFASNet):
    """
    MiniFASNet model with Squeeze-and-Excitation blocks for face anti-spoofing.
    """
...
def MiniFASNetV1(embedding_size=128, conv6_kernel=(7, 7),
    ...
    """
    Create MiniFASNetV1 model.

    Args:
        embedding_size (int): Size of the embedding.
        conv6_kernel (tuple): Kernel size for the 6th convolution layer.
        drop_p (float): Dropout probability.
        num_classes (int): Number of output classes.
        img_channel (int): Number of input image channels.

    Returns:
        MiniFASNet: MiniFASNetV1 model.
    """
...
def MiniFASNetV1SE(embedding_size=128, conv6_kernel=(7, 7),
    ...
    Returns:
        MiniFASNetSE: MiniFASNetV1SE model.
    """
...
def MiniFASNetV2SE(embedding_size=128, conv6_kernel=(7, 7),
    ...
    Returns:
        MiniFASNetSE: MiniFASNetV2SE model.
    """
